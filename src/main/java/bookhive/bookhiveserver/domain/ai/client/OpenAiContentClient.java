...
public class OpenAiContentClient implements AiContentClient{
    ...
    public AiCorrectResponse correct(String content) {
        ...
        // user: 입력 프롬프트
        // entity: 어떤 형식으로 받을지 인 것 같은데
        return this.chatClient.prompt()
                .system(prompt)
                .user(content)
                .call()
                .entity(AiCorrectResponse.class);
    }
    ...
    public AiRecommendTagsResponse recommendTags(String content, String originTags) {
        ...
        return this.chatClient.prompt()
                ...
                .user(content)
                .call()
                .entity(AiRecommendTagsResponse.class);
    }
}
